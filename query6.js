...
async function run() {
  ...
  querySnapshot.forEach((doc) => {
    const data = doc.data();
    console.log(`Exam ID: ${doc.id}, Title: ${data.title}, Materi: ${data.materi}, Kelas: ${data.kelas}, targets: ${JSON.stringify(data.targets)}, targetClasses: ${JSON.stringify(data.targetClasses)}`);
  });
}
